    ...
    <head>
        ...
        <div class="row">
            <div class="col s6 offset-l3 card-content center" id="card_Cad_Usuario" align="center">
                <form class="col s12" method="post" action="ProdutoControle?metodo=insert">
                    ...
                    <div class="row">
                        <div class="input-field col s4">
                            <input placeholder="Quantidade"  type="number" class="validate" min="0" max="5" name="quantidade">
                    ...
                    <div class="row">
                        <div class="input-field col s10  right-align">
                            <button class="waves-effect waves-light btn  blue-grey" type="submit" name="cancelar">
                                Cancelar <i class=" center-align "></i>
                            </button>
                        </div>
                        <div class="input-field col s2 right-align">
                            <button class="waves-effect waves-light btn blue" type="submit" name="metodo">
