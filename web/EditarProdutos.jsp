                ...
                <form class="col s8">
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            <input placeholder="Id Produto" id="first_name" type="text" class="validate" name="id_produto" requered>
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input placeholder="Nome do Produto" id="first_name" type="text" class="validate" name="nome_produto" requered>
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input placeholder="Descrição do Produto" id="first_name" type="text" class="validate" name="descricao" requered>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s4">
                            <input placeholder="Quantidade" id="first_name" type="text" class="validate" name="quantidade" requered>
                        ...
                        <div class="input-field col s4">
                            <input placeholder="Preço" id="first_name" type="text" class="validate" name="preco" requered>
