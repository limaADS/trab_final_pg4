                            ...
                            <table class="striped  bordered striped centered " >
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>$0.87</td>
                                        <td>$0.87</td>
                                        <td><a class="waves-effect waves-light btn-small black-text"><i class="material-icons">border_color</i></a></td>
                                        <!--<td><a class="waves-effect waves-light btn-small black-text"><i class="material-icons">delete_forever</i></a></td>-->
                                    </tr>
